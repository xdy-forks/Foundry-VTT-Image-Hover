...
* **Author**: Eriku#2108 (Discord), xdy#3735 (Discord)
* **Version**: 2.0.0
...
2.  Click the Install Module button and enter the following URL:<br>https://github.com/xdy-forks/Foundry-VTT-Image-Hover/releases/latest/download/module.json.
